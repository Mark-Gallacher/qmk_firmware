...
// ||-------AA-------|-------SS-------|-------DD-------|-------FF-------|-------GG-------|| ||-------HH-------|-------JJ-------|-------KK-------|-------LL-------|-------;;-------||
       LGUI_T(KC_A),    LALT_T(KC_S),    LSFT_T(KC_D),    LCTL_T(KC_F),        KC_G,                KC_H,        RCTL_T(KC_J),    RSFT_T(KC_K),    LALT_T(KC_L),    RGUI(KC_SCLN),
// ||----------------|----------------|----------------|----------------|----------------|| ||----------------|----------------|----------------|----------------|----------------||
// ||-------ZZ-------|-------XX-------|-------CC-------|-------VV-------|-------BB-------|| ||-------NN-------|-------MM-------|-------,,-------|-------..-------|-------//-------||
           KC_Z,         LT(0, KC_X),    LT(0, KC_C),     LT(0, KC_V),         KC_B,                KC_N,            KC_M,           KC_COMM,         KC_DOT,         KC_SLSH,
// ||----------------|----------------|----------------|----------------|----------------|| ||----------------|----------------|----------------|----------------|----------------||
// ||-------------------------------------------------||----------------|----<SPACE>-----|| ||--<BACKSPACE>---|----------------||
		    					                            TO(_NAV),     LT(0, KC_SPACE),      LT(0, KC_SPC),     TO(_SYM)
// ||-------------------------------------------------||----------------|----------------|| ||----------------|----------------||
  ),

  [_SYM] = LAYOUT(
  //-ESP---------@@@-----###-------------$$$-----------------%%%-----------------           -^^^--------{{{----------}}}----------;;;--------BSC----------------
    KC_ESCAPE,  KC_AT,  LSFT(KC_3),     TD(DANCE_31),       KC_PERC,                        KC_CIRC,    KC_LBRC,   KC_RBRC,    KC_SCLN,  KC_BSPC ,
  //-TAB----------===----???-------///-----------'''-----------------------------           -***--------[[[----------]]]-------------------|||----------ENT-----
    KC_TAB,     KC_EQL, KC_QUES,  KC_SLSH,      KC_QUOT,                                    KC_ASTR,   LSFT(KC_LBRC), LSFT(KC_RBRC),   TD(PIPE_END),  KC_ENTER,
  //-|~~~|-------£££-------------####---------$$$-------------"""----------------           -&&&--------(((----------)))----------\\\---------------------------
    KC_TILD,    TD(DANCE_33),  LSFT(KC_3),  TD(DANCE_31),    KC_DQUO,                       KC_AMPR,    KC_LPRN,    KC_RPRN,  TD(BKSL_HME),    TO(3),
  //-----------------------------------------------------------------------------           ---------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------             ----------------------------------------------------------------------------
    QK_BOOTLOADER,   KC_KP_ASTERISK, KC_BRIGHTNESS_DOWN,    KC_BRIGHTNESS_UP,   KC_KP_DOT,              KC_0,   KC_1, KC_2, KC_3,   KC_TRANSPARENT,
  //---------------------------------------------------------------------------------------             ----------------------------------------------------------------------------
	  TO(_BASE), KC_LGUI,                                                                                   KC_RALT ,TO(3)
  ),

    //LGUI(KC_LBRACKET),LCTL(LSFT(KC_TAB)),RCTL(KC_TAB),   LGUI(KC_RBRACKET),KC_TRANSPARENT,

  [3] = LAYOUT(
    TD(DANCE_54),   KC_MS_WH_LEFT,  KC_MS_UP,       KC_MS_WH_RIGHT, TD(DANCE_55),                   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
                        TO(_BASE),KC_TRANSPARENT,                                                     KC_RALT, TO(_SYM)
  )
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case LT(0, KC_SPC):
            if (!record->tap.count && record->event.pressed) {
                tap_code16(KC_ENTER); // Intercept hold function to send Ctrl-BackSpace
                return false;
            }

...
// ||-------------------------------------------------||----------------|----------------|| ||----------------|----------------||
  ...
  [_SYM] = LAYOUT(
// ||----<ESCAPE>----|------ ++ ------|-------\|-------|-------/?-------|-------%%-------|| ||-------""-------|-------{{-------|-------}}-------|-------!!-------|--<BACKSPACE>---||
        KC_ESCAPE,         KC_PLUS,         UK_BSLS,         KC_SLSH,         KC_PERC,             UK_DQUO,         KC_LBRC,         KC_RBRC,        KC_EXLM,      LT(0, KC_BSPC),
// ||----------------|----------------|----------------|----------------|----------------|| ||----------------|----------------|----------------|----------------|----------------||
// ||-----<TAB>------|------ -- ------|------ =+ ------|------ __ ------|-------$$-------|| ||-------^^-------|-------[[-------|-------]]-------|-------::-------|----<ENTER>-----||
          KC_TAB,          KC_MINS,          KC_EQL,         KC_UNDS,         KC_DLR,              KC_CIRC,      LSFT(KC_LBRC),   LSFT(KC_RBRC),     KC_COLN,      LT(0, KC_SPACE),
// ||----------------|----------------|----------------|----------------|----------------|| ||----------------|----------------|----------------|----------------|----------------||
// ||------ `~ ------|-------**-------|-------<<-------|------->>-------|-------@@-------|| ||-------##-------|-------((-------|-------))-------|------ ~~ ------|-------&&-------||
          UK_GRV,          KC_ASTR,          KC_LT,           KC_GT,           UK_AT,              UK_HASH,         KC_LPRN,         KC_RPRN,         UK_TILD,          KC_AMPR,
// ||----------------|----------------|----------------|----------------|----------------|| ||----------------|----------------|----------------|----------------|----------------||
// ||-------------------------------------------------||----------------|-----<CTRL>-----|| ||-----<SHIFT>----|----------------||
...
// ||-------//-------|-------11-------|-------22-------|-------33-------|------ -- ------|| ||-------^^-------|-------%%-------|------ ,, ------|------ .. ------|----------------||
         KC_SLSH,           KC_1,            KC_2,            KC_3,         KC_MINUS,             KC_CIRC,          KC_PERC,          KC_COMM,        KC_DOT,         TO(_SYM),
// ||----------------|----------------|----------------|----------------|----------------|| ||----------------|----------------|----------------|----------------|----------------||
// ||-------------------------------------------------||----------------|-----<CTRL>-----|| ||-----<SHIFT>----|----------------||

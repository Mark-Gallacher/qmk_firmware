...
// ||-------------------------------------------------||----------------|----------------|| ||----------------|----------------||
  ...
  [_SYM] = LAYOUT(
// ||----<ESCAPE>----|------ ++ ------|-------\|-------|-------/?-------|-------%%-------|| ||-------""-------|-------[[-------|-------]]-------|-------!!-------|------ '' ------||
        KC_ESCAPE,         KC_PLUS,         UK_BSLS,         KC_SLSH,         KC_PERC,             UK_DQUO,        KC_LBRC,         KC_RBRC,        KC_EXLM,          KC_QUOT,
// ||----------------|----------------|----------------|----------------|----------------|| ||----------------|----------------|----------------|----------------|----------------||
// ||-----<TAB>------|------ -- ------|------ =+ ------|------ __ ------|-------$$-------|| ||-------^^-------|-------((-------|-------))-------|-------::-------|------;;--------||
          KC_TAB,          KC_MINS,          KC_EQL,         KC_UNDS,         KC_DLR,              KC_CIRC,        KC_LPRN,         KC_RPRN,         KC_COLN,         KC_SCLN,
// ||----------------|----------------|----------------|----------------|----------------|| ||----------------|----------------|----------------|----------------|----------------||
// ||------ `~ ------|-------<<-------|------->>-------|-------**-------|-------@@-------|| ||-------##-------|-------{{-------|-------}}-------|------ ~~ ------|-------&&-------||
